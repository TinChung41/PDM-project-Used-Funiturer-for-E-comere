...
if(isset($_SESSION['email'])){
  ...
  if(isset($_GET['cart_id'])){
	...
	if ($rows>0) {
	  ...
	  $cart_query = "INSERT INTO 'cart'('cust_id', 'product_id',quantity) VALUES ($custid,$p_id,1)";    
		if (sqlsrv_query($conn,$sel_cart,$params,$options)) {
        ...
        <div class="carousel slide mt-5" id="slider" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                 <img src="img/tu-ruou.png" class="d-block w-100">
                
               </div>
               <div class="carousel-item">
                  <img src="img/bed-room.jpg" class="d-block w-100">
               </div>
               <div class="carousel-item">
...
*/				  
                  ...
                  $p_query = "SELECT TOP 4 * FROM furniture_product ORDER BY pid DESC";
/*mysql				  
                  $p_run   = mysqli_query($con,$p_query);
*/				  
					if (($rs=sqlsrv_query($conn,$p_query,$params,$options)) == false)
					{
						echo  print_r(sqlsrv_errors(), true);
					}
					
/*mysql                  if(mysqli_num_rows($p_run) > 0 ){ */
					
					$rows=sqlsrv_num_rows($rs);	
					if ($rows>0) {
					  
/*                      while($p_row = mysqli_fetch_array($p_run)){*/
					while($p_row=sqlsrv_fetch_array($rs)) {
